...
import { buildChannelsXml, buildProgramsXml, buildXmltv, escapeXml, formatDate } from "./xmltv.js";
...
describe("buildXmltv", () => {
    ...
    it("should include channel information", () => {
        ...
        expect(result).toContain("<display-name>AMERICAN BROADCASTING COMPANY</display-name>");
    ...
    it("should include rating information", () => {
        const result = buildXmltv(mockData);
        expect(result).toContain('<rating system="MPAA"><value>TV-PG</value></rating>');
    });
    ...
    it("should handle missing optional fields", () => {
        ...
        expect(result).toContain('<programme start="20250718190000 +0000" stop="20250718193000 +0000" channel="123">');
...
describe("buildChannelsXml", () => {
    it("should build channel XML correctly", () => {
        ...
        expect(result).toContain("<display-name>AMERICAN BROADCASTING COMPANY</display-name>");
        expect(result).toContain("<display-name>4.1</display-name>");
        expect(result).toContain('<icon src="https://ebyl.tmsimg.com/h3/NowShowing/19629/s28708_ll_h15_ac.png" />');
    });
